                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-6">
                        ...
                        <label for="alamat_santri" class="form-label">Alamat Santri <span class="text-danger">*</span></label>
                            <textarea class="form-control" id="alamat_santri" name="alamat_santri" rows="4" required placeholder="Masukkan alamat lengkap">{{ old('alamat_santri') }}</textarea>
                    </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="nis" name="nis" value="{{ old('nis') }}" required placeholder="Masukkan NIS">
                        </div>
                        
                        <div class="mb-4">
                            <label for="nomor_hp_santri" class="form-label">Nomor HP Santri</label>
                            <input type="text" class="form-control" id="nomor_hp_santri" name="nomor_hp_santri" value="{{ old('nomor_hp_santri') }}" placeholder="Masukkan nomor HP">
                        </div>
