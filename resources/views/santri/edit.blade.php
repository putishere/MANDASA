            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="username" name="username" value="{{ old('username', $santri->username) }}" required>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="nis" name="nis" value="{{ old('nis', $santri->santriDetail->nis ?? '') }}" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="alamat_santri" class="form-label">Alamat Santri <span class="text-danger">*</span></label>
                        <textarea class="form-control" id="alamat_santri" name="alamat_santri" rows="3" required>{{ old('alamat_santri', $santri->santriDetail->alamat_santri ?? '') }}</textarea>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="nomor_hp_santri" class="form-label">Nomor HP Santri</label>
                        <input type="text" class="form-control" id="nomor_hp_santri" name="nomor_hp_santri" value="{{ old('nomor_hp_santri', $santri->santriDetail->nomor_hp_santri ?? '') }}">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
